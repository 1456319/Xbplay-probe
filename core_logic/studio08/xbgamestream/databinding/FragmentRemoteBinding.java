...
public final class FragmentRemoteBinding implements ViewBinding {
    ...
    public final TextView textRemoteFooter;
    public final TextView textRemoteHeader;
    public final StreamWebview webview1;

    private FragmentRemoteBinding(ConstraintLayout constraintLayout, FloatingActionButton floatingActionButton, Button button, Button button2, ConstraintLayout constraintLayout2, TextView textView, TextView textView2, StreamWebview streamWebview) {
        ...
        this.textRemoteFooter = textView;
        this.textRemoteHeader = textView2;
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (streamWebview != null) {
                                return new FragmentRemoteBinding(constraintLayout, floatingActionButton, button, button2, constraintLayout, textView, textView2, streamWebview);
                            }
                        }
                    }
                }
